...
export function pranchetaControllerGet(http: HttpClient, rootUrl: string, params: PranchetaControllerGet$Params, context?: HttpContext): Observable<StrictHttpResponse<Prancheta>> {
