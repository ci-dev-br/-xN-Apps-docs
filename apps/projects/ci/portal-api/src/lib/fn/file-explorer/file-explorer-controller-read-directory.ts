...
export function fileExplorerControllerReadDirectory(http: HttpClient, rootUrl: string, params: FileExplorerControllerReadDirectory$Params, context?: HttpContext): Observable<StrictHttpResponse<void>> {
