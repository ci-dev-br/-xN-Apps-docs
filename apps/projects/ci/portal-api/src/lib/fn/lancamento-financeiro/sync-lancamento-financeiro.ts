...
export function syncLancamentoFinanceiro(http: HttpClient, rootUrl: string, params: SyncLancamentoFinanceiro$Params, context?: HttpContext): Observable<StrictHttpResponse<LancamentoFinanceiro>> {
  ...
  return http.request(
    ...
    map((r: HttpResponse<any>) => {
      return r as StrictHttpResponse<LancamentoFinanceiro>;
    })
  );
}
