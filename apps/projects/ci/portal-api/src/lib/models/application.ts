...
export interface Application {
  ...
  /**
   * Os usuários da aplicação são aqueles que fizeram registro ou possuem licença de uso da aplicação. Algumas aplicações podem exigir licença para uso de módulos específicos.
   */
